...
export function createModuleRuntime(loadableApis: LoadableApis, runtime: Record<string, any>): SDK7Module {
  ...
  Object.defineProperty(runtime, 'require', {
    ...
    value: (moduleName: string) => {
      ...
      const module = loadSceneModule(loadableApis, moduleName)
...
function loadSceneModule(loadableApis: LoadableApis, moduleName: string): GenericRpcModule {
